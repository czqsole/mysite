...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_two_past_question(self):
        create_quesiton(question_text="Past question 1.", days=-30)
        create_quesiton(question_text="Past question 2.", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
...
class QuestionIndexDetailTests(TestCase):
    def test_detail_with_a_future_quesiton(self):
        future_question = create_quesiton(question_text='Future quesiton.', days=5)
